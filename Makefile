...
ifdef EMSCRIPTEN
	...
	PLATFORM_CFLAGS=-Oz -s USE_SDL_TTF=2 -s USE_SDL_MIXER=2 -s USE_SDL_IMAGE=2 -s USE_OGG -s USE_VORBIS -s ALLOW_MEMORY_GROWTH=1 --preload-file bin/data@/data --use-preload-plugins $(WEBGL_FLAGS)
	PLATFORM_LDFLAGS=
else
	OUT_FILE=$(EXEC)
